...
'actions' => array ('create','update','admin','delete' ),'users' => array ('@' ) ),array ('deny', // deny all users
'users' => array ('*' ) ) );
	}
	...
	public function actionAdmin()
	{
		if (Yii::app()->authManager->checkAccess('verApplicationImages', Yii::app()->user->getState("rolId")))
		{
			...
			if (isset($_GET['ApplicationImages'])) $model->attributes = $_GET['ApplicationImages'];
