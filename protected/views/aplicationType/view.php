...
$this->menu=array(
	...
	array('label'=>'Update AplicationType', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete AplicationType', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
