...
$this->menu=array(
	...
	array('label'=>'Update ApplicationImages', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete ApplicationImages', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
