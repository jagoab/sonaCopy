...
<body>
	...
	<div class="container">
		<img
			src="http://dascomla.com/sonaray-ensamble/images/logistic/logistic.png"
    ...
    <?php foreach ($parrafos as $valor):?>
		...
		<center>
			<div style="">
				<div style='width: 18%;'>
					<img
						src="<?php //echo Yii::app()->request->baseUrl.$imagenesAboutUs[$i]->path; ?>"
						style="width: 100%;" />
				</div>

				<div
					style='width: 60%; border: 0px solid green; text-align: justify; font-family: Arial; font-size: 14px;'>

					<strong><?php echo $valor[1]->text; ?></strong><br /> <br /> <span
