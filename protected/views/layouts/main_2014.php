																																																				...
																																																				foreach ($menus as $menu)
																																																				{
																																																					if ($menu['parent'] == 0)
																																																					{
																																																						...
																																																						{ // para saber si tiene hijos
																																																							?>
                                                                <li
								style="color: #000000; font-weight: bold;"><?php echo CHtml::link($menu['name'], array($menu['url']), array('role' => "menuitem")); ?></li>              
                                                            <?php } else { ?>
                                                                <li
				...
				<div
					...
					<span style="padding: 10px; cursor: pointer;" id="impressum">
						...
						style="display: none;">
							...
							Telefon: +49 (0) 731 - 20 75 - 0<br /> Telefax: +49 (0) 731 - 20
							75 - 100<br /> email: info.de@dascom.com<br /> Diese
							...
							Registergericht: Amtsgericht Ulm<br /> Registernummer: HRB 723920<br />
							USt.-IdNr.: DE264947359<br /> WEEE-Reg-Nr.: DE 39196009<br /> <br />
							<br /> <b>Haftungshinweis:</b><br /> Trotz sorgfältiger
							inhaltlicher Kontrolle übernimmt DASCOM keine Haftung für die
