	...
	<div style="min-height: 100px;">
		...
		<div id="slider1_container"
			...
			<div u="slides"
				...
				<div>
					<img u="image"
						src2="<?php echo Yii::app()->request->baseUrl; ?>/images/home/luz.jpg" />
				</div>
				<div>
					<img u="image"
						src2="<?php echo Yii::app()->request->baseUrl; ?>/images/home/red.jpg" />
				</div>
				<div>
					<img u="image"
						src2="<?php echo Yii::app()->request->baseUrl; ?>/images/home/purple.jpg" />
				</div>
...
.jssora21rdn {
						...
						<nav role="navigation" class="navbar navbar-inverse">
							...
							<div id="navbarCollapse" class="collapse navbar-collapse">
								<ul class="nav navbar-nav">
									<li style="background: #FFFFFF"><a href="index.php"
										style="color: #000000; font-weight: bold;">HOME</a></li>
									...
									<li class="dropdown"><a data-toggle="dropdown"
										class="dropdown-toggle" href="#"
										style="color: #666666; font-weight: bold;">SOLUTIONS <b
											class="caret"></b></a>
										<ul role="menu" class="dropdown-menu">
									...
									<li class="dropdown"><a data-toggle="dropdown"
										...
										<ul role="menu" class="dropdown-menu">
											...
											<li><a href="roi.php" style="font-weight: bold;">ROI
													Calcultor</a></li>
	...
	<div class="container">
		...
		<h2>
			Discover innovation <br /> <br />in Sonaray we want you to be well,
			live well and enjoy life. By understanding their aspirations and
			needs you become what inspires us.<br /> <br />
		...
		<div class="row">
			<div class="col-md-6">
				<div class="block" data-move-x="-600px" style="border: 6;">
					<strong><p style="font-size: 28px; color: #003399;" align='left'>
							About us</p> </strong>
					<p style="font-size: 28x;" align='left'>________________</p>
					<p align="justify"
						style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #666666;">DASCOM&rsquo;s
					...
					<p style="font-size: 28x;" align='right'>VER MAS</p>
				</div>
			</div>
			<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="block" data-move-x="800px" style="background: #ffffff">
					<br /> <strong>
						<p style="font-size: 48x; color: #003399;" align='left'>History</p>
					</strong>
					<p style="font-size: 28x;" align='left'>________________</p>
					<p align="justify"
						style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #666666;">DASCOM&rsquo;s
		...
		<div class="row">
			<div class="col-md-3">
				<div class="block" data-rotate-y="180deg" data-move-z="-200px"
					data-move-x="-300px">
					<img
						src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/cma_1.jpg"><br />
					<p align="justify"
						style="font-family: Arial, Helvetica, sans-serif; color: #666666;">
						This is a sample content for foxcameras, the world of cameras This
						is a sample content for foxcameras, the world of cameras This is a
						sample content for foxcameras, the world of cameras <img
							src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/boton.jpg" />
					</p>
				</div>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="block" data-rotate-x="90deg" data-move-z="-500px"
					...
					<p></p>
					<p align="justify"
						style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #666666;">
		...
		<div style="width: 100%; height: 400px; background-color: #003399;">
			<br /> <br /> <br /> <br /> <br /> <br /> <a
				onMouseOver="cambiar(1,'IMG2');" onMouseOut="cambiar(0,'IMG2');"
				target="_blank" href="http://www.facebook.com/"> <img border="0"
			...
			<p style="color: #ffffff;">in construction Sonaray
	...
	<script
		src="<?php echo Yii::app()->request->baseUrl; ?>/js/docs.min.js"></script>
	<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	<script
		src="<?php echo Yii::app()->request->baseUrl; ?>/js/ie10-viewport-bug-workaround.js"></script>

	<!-- jssor slider scripts-->
	<!-- use jssor.js + jssor.slider.js instead for development -->
	<!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
	<script type="text/javascript"
		src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.smoove.min.js"></script>
	<script>
