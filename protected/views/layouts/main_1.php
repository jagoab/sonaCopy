...
<body> 
                            ...
                            <div id="modal_cargando"
		style="display: none; z-index: 1000000000000000;">
		<img class="load_grande"
			src="<?php echo Yii::app()->request->baseURL; ?>/images/loader.gif" />
			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="flotar">
					<p align="center" class="Estilo5"
						style="font-size: 38px; font-family: Impact; color: #003399;">Creating
						the future</p>
					<p align="center" class="Estilo6"
						style="font-size: 18px; font-family: Century Gothic; color: #CCCCCC;">Iluminando
						los sueños de todos!
	...
	<div style="min-height: 100px;">
		...
		<div id="slider1_container"
			style="display: none; position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; z-index: 0;">
			<!-- Loading Screen -->
			<div u="loading" style="position: absolute; top: 0px; left: 0px;">
				<div
					style="filter: alpha(opacity = 70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 1200%; height: 100%;">
				</div>
				<div
	...
	<div style="min-height: 100px;">
		...
		<div id="slider1_container"
			...
			<div class="container" id="page">	
                                ...
                                <?php
																																if (!isset(Yii::app()->session['flag'])) Yii::app()->session['flag'] = 'us';
																																?>
                                <div id="header">
					...
					<div class="logo-sonary" style="">
                                     <?php
																																					...
																																					if (@ strtolower(Yii::app()->session['flag']) == 'us')
																																					{
																																						?> <div id="xxff"
							style="color: #000;">

							<div
								style="margin-right: 50px; position: fixed; margin-left: 55%; top: 0px; z-index: 1001;"
								id="xxf">
								<a target="_new"
									href="http://www.dascomamericas-info.com/LED/promo/index.html ">
									<img alt=""
									src="<?php //echo Yii::app()->request->baseUrl . "/images/special_promotion_02.png" ?>">
								</a>
					...
					<div class="idioma">
						<div class="dropdown helvetica_condensed_lightRg">
							<img width="32px;"
								src="<?php echo Yii::app()->request->baseURL; ?>/images/flag/<?php echo Yii::app()->session['flag']; ?>.png" />
                                            <?php echo CHtml::link(Yii::t('forms', 'Change Country'), array('site/selector')); ?> 
                                            <?php if (Yii::app()->session['flag'] == 'hk'): ?>                                            
                                                <li><a
								href="<?php echo Yii::app()->request->baseUrl . "/en/site/flagUrl?flag=hk&lang=en" ?>"><?php echo Yii::t('forms', 'English') ?></a></li>
							<li><a
								href="<?php echo Yii::app()->request->baseUrl . "/en/site/flagUrl?flag=hk&lang=ch" ?>"><?php echo Yii::t('forms', '中国') ?></a></li>                                           
                                            <?php endif; ?>

                                            <?php if (Yii::app()->session['flag'] == 'sg'): ?>

                                                <li><a
								href="<?php echo Yii::app()->request->baseUrl . "/en/site/flagUrl?flag=sg&lang=en" ?>"><?php echo Yii::t('forms', 'English') ?></a></li>
							<li><a
								href="<?php echo Yii::app()->request->baseUrl . "/ch/site/flagUrl?flag=sg&lang=ch" ?>"><?php echo Yii::t('forms', '中国') ?></a></li>                                           
                                            <?php endif; ?>
				...
				<!--------------------------------------------------------------------------------------->
                                ...
                                <div>
					<div class=" helvetica_neueregular"
																																																				...
																																																				foreach ($menus as $menu)
																																																				{
																																																					if ($menu['parent'] == 0)
																																																					{
																																																						...
																																																						{ // para saber si tiene hijos
																																																							?>
                                                                <li
										style="font-size: 15px;"><?php echo CHtml::link($menu['name'], array($menu['url']), array('role' => "menuitem")); ?></li>              
                                                            <?php } else { ?>
                                                                <li
										class="dropdown"><a style="font-size: 15px;" href="#"
										class="dropdown-toggle" data-toggle="dropdown"><?php echo $menu['name'] ?></a>
						...
						<!--fin de class="navbar navbar-default"-->
						...
						<div
							...
							<span style="padding: 10px; cursor: pointer;" id="impressum">
								...
								style="display: none;">
									...
									Telefon: +49 (0) 731 - 20 75 - 0<br /> Telefax: +49 (0) 731 -
									20 75 - 100<br /> email: info.de@dascom.com<br /> Diese
									E-Mail-Adresse ist gegen Spambots geschützt! Sie müssen
									JavaScript aktivieren, damit Sie sie sehen können.<br />
									Internet: <a href="http://www.dascom.com">www.dascom.com</a> <br />
									<br /> <b>Geschäftsführer:</b><br /> Holger Benke<br /> <br />
									Registergericht: Amtsgericht Ulm<br /> Registernummer: HRB
									723920<br /> USt.-IdNr.: DE264947359<br /> WEEE-Reg-Nr.: DE
									39196009<br /> <br /> <br /> <b>Haftungshinweis:</b><br />
									Trotz sorgfältiger inhaltlicher Kontrolle übernimmt DASCOM
							...
							<span style="padding: 10px;"> <a style="color: #999;"
								target="_blank"
						...
						<div
							...
							Produktnamen sind Marken der jeweiligen Eigentümer.
                                                ...
                                                <?php
                                                  ...
                                                  Powered by 
                                            <a
							href="http://www.thefactoryhka.com" " target="_blank"
							style="color: #666"><img
							src="http://www.dascomla.com/sonaray/images/thfka.png" width="14"
							height="11" /> ThefactoryHKA C.A.</a>
						</p>
					</div>
