...
<link rel="stylesheet" type="text/css"
	href="<?php echo Yii::app()->request->baseUrl; ?>/css/awesomeIconFonts/font-awesome.css" />
<link rel="stylesheet" type="text/css"
							...
							<ul class="nav navbar-nav">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li style="font-size: 15px;" class=""><a
											href="<?php echo Yii::app()->request->baseUrl . '/' . $menu2['url']; ?>"><?php echo $menu2['name'];?></a></li>
                                                                                    <?php
			...
			<div class="lista<?php echo $i; ?>">
				...
				<span style="padding: 0; height: auto;">
					<div class="imagenesCarrousel"
						style="clear: both; float: left; width: 100%; padding-left: 1.4%;">
...
<?php  endforeach; ?>
		...
		id="carouselContent<?php echo $cat; ?>" type="<?php echo $cat; ?>"
			...
			<div id="foo<?php echo $cat; ?>" class="col-md-12">
                        <?php
									...
									:
										...
										{
											?>    
                            <img class="img_producto"
					type="<?php echo $img['id_producto'] ?>"
					id_2='<?php echo $img['id_producto'] ?>'
					idx="<?php echo  $img['id_producto']; ?>" width="121" height="84"
					src="<?php echo Yii::app()->request->baseUrl . $img['path']; ?>" />		  	               	  		    
                            <?php
										}
										$i++ ;
									endforeach
