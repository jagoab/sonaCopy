...
.container {
	...
	<center>
		...
		<div style="width: 1200px; text-align: left;">
			<p>
				<img
					src="http://www.dascomla.com/sonaray-ensamble/images/img/where_to_buy.png"
					width="975" height="82" alt="" />
			</p>
			<p>&nbsp;</p>
			<p
				style="font-size: 18px; font-family: Arial; color: #999; text-align: left;">1
				Where To Buy</p>
			<p
				style="font-size: 12px; font-family: Arial; color: #999; text-align: left;">ejemplos
				ejemplosejemplos , ejemplos ejemplosejemplos , ejemplos
				ejemplosejemplos , ejemplos ejemplosejemplos , ejemplos
				ejemplosejemplos , ejemplos ejemplosejemplos , ejemplos
				ejemplosejemplos , ejemplos ejemplosejemplos , ejemplos
				ejemplosejemplos , ejemplos ejemplos ejemplos , ejemplos ejemplos.</p>
			<p
				style="font-size: 18px; font-family: Arial; color: #999; text-align: left;">&nbsp;</p>
		</div>
