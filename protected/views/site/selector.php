...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="flag">
          ...
          <a class="widthFlag" title="ES-SI" href="<?php echo Yii::app()->request->baseUrl."/en/site/flagUrl?flag=sg&lang=en"  ?>"><img width="32px;" src="<?php echo Yii::app()->request->baseURL; ?>/images/flag/sg.png"/>  <?php echo Yii::t('forms','Singapore') ?></a>
      </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="flag">
         <a  title="ES-DE" href="<?php echo Yii::app()->request->baseUrl."/en/site/flagUrl?flag=al&lang=du"  ?>"><img width="32px;" src="<?php echo Yii::app()->request->baseURL; ?>/images/flag/de.png"/>  <?php echo Yii::t('forms','Deutschland'); ?>  </a>
      </div>
