...
<map name="map1">
  ...
  <area href="<?php echo Yii::app()->request->baseUrl."/es/site/flagUrl?flag=mx&lang=es"  ?>" title="ES-MX" shape=circle coords="145,247,25" />
  <area href="<?php echo Yii::app()->request->baseUrl."/es/site/flagUrl?flag=pa&lang=es"  ?>" title="ES-PA" shape=circle coords="188,278,18" />
