...
$this->menu=array(
	...
	array('label'=>'Update CountriesLanguages', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete CountriesLanguages', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
