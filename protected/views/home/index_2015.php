        ...
        <h3 style="background-color: rgba(80,80,80,.5)">Discover How Sonaray is <br/><b>Lighting Everyone's Dreams</b></h3>
            ...
            foreach ($imagenesSlider as $banner) {
                if ($i == 0) {
                    $i++;
                    ?>
                    <div class="item <?php if (!$usa) echo 'active'; ?> ">
...
<div class="row">   
    ...
    <div class="col-md-4 col-sm-4 col-lg-4"> 
        ...
        <?php foreach ($featured_product as $imagenesCasosDescarga): ?>
              <a href="<?php echo Yii::app()->baseUrl."/".Yii::app()->language."/products/index?idclick=".$imagenesCasosDescarga['id'] ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl.$imagenesCasosDescarga['path'],"",array('width'=>'80%','class'=>'img-thumbnail')); ?></a>
        <?php endforeach; ?>
    </div>
