...
<?php echo CHtml::link($menu['name'], array($menu['url']), array('role' => "menuitem")); ?>
</li>
<?php 
$contador++; 
}
...
<li class="dropdown" style="color: #000000; font-weight: bold;">
	<a style="font-size: 15px;" href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $menu['name'] ?> <b class="caret"></b> </a>
...
<div class="container">
	<h2>in Sonaray we want you to be well, live well and enjoy life. By
		understanding their aspirations and needs you become what inspires us.</h2>
	<br />
	<div class="row">
		<div class="col-md-6">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="block" data-move-x="800px" style="background: #ffffff">
				<br />
				<strong><p style="font-size: 48x; color: #003399;" align='left'>History</p></strong>
				<p style="font-size: 28x;" align='left'>________________</p>
				<p align="justify"
					style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; color: #666666;">DASCOM&rsquo;s
					LED Lighting business is at the forefront of lighting the world of
	...
	<div style="width: 100%; height: 400px;">
		<img
			src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/banner.png"
	...
	<div class="row">
		<div class="col-md-3">
			<div class="block" data-rotate-y="180deg" data-move-z="-200px"
				data-move-x="-300px">
				<img
					src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/cma_1.jpg"
					alt="a cute kitten"><br />
				<p align="justify"
		...
		<div class="col-md-4">
			<div class="block" data-rotate-x="90deg" data-move-z="-500px"
				...
				<p align="justify"
					...
					LED lighting solutions, our mission is to provide the absolute best
					in energy efficient lighting. With a broad array of research,
					development, test and production capabilities and facilities, our
					experienced team is dedicated to producing only the highest quality
					LED lights.</p>
			</div>
		</div>
		<div class="col-md-4">
