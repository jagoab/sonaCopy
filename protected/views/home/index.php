...
<body style="padding:0px; margin:0px; font-family:Arial, Verdana;background-color:#fff;">
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(http://www.dascomla.com/sonaray/images/285.GIF) no-repeat center center;
                top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
        </div>
        <!-- Slides Container -->
  ...
  <div class="container">
    ...
    <div class="row">
       <div class="col-md-6"><div class="block" data-move-x="-800px" ><img
                    src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/img_2.jpg"
    alt="a cute kitten"></div></div>
 ...
 <div style="width:100%; height:400px;  " >
    <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/home/banner.png" class="img-responsive" />
    </div>
    ...
    alt="a cute kitten"><br/><p align="justify" style="font-family: Arial, Helvetica, sans-serif;
