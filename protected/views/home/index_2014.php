...
<?php
$this->beginWidget('zii.widgets.jui.CJuiDialog', array ('id' => 'videodialog','options' => array ('title' => 'Sonaray Special Promotion','autoOpen' => false,'modal' => true,'width' => "80%",'min-height' => 400,'position' => 'top' ) ));
?>
...
<a
	href="<?php echo Yii::app()->baseUrl . "/products/index?idclick=123" ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/banner-ep.jpg'); ?></a>
<?php
$this->endWidget();
...
if (@ strtolower(Yii::app()->session['flag']) == 'us')
{
	...
	?>
            ...
            -->
                      ...
                      <?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/banner-ep.jpg'); ?>
...
foreach ($imagenesSlider as $banner)
{
	if ($i == 0)
	{
		...
		?>
                    <div
			class="item <?php if (!$usa) echo 'active'; ?> ">
...
<div class="row">
	<div class="col-md-4 col-sm-4 col-lg-4"> 
        ...
        <?php foreach ($imagenesCasos as $imagenesCaso): ?>
            <a
			href="<?php echo Yii::app()->request->baseUrl . "/" . $imagenesCaso['subPath'] ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . $imagenesCaso['path'], "", array('width' => '100%')); ?></a>
        <?php endforeach; ?>
    </div>
	...
	<div class="col-md-4 col-sm-4 col-lg-4"> 
        ...
        <?php foreach ($imagenesDescargas as $imagenesDescarga): ?>
            <a
			href="<?php echo Yii::app()->request->baseUrl . "/" . $imagenesDescarga['subPath'] ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . $imagenesDescarga['path'], "", array('width' => '100%')); ?></a>
        <?php endforeach; ?>
    </div>
	...
	<div class="col-md-4 col-sm-4 col-lg-4"> 
        ...
        <?php foreach ($featured_product as $imagenesCasosDescarga): ?>
              <a
			href="<?php echo Yii::app()->baseUrl."/".Yii::app()->language."/products/index?idclick=".$imagenesCasosDescarga['id'] ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl.$imagenesCasosDescarga['path'],"",array('width'=>'80%','class'=>'img-thumbnail')); ?></a>
        <?php endforeach; ?>
    </div>
