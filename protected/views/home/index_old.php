...
<div style="clear:both; float:left; padding-left: 7%;margin-top: 5%; font-family: helvetica_neueregular !important">
	...
	<div class="row">
		...
		<div class="col-md-6">
		<div class="block" data-move-x="600px" >
			<iframe width="560" height="300" src="//www.youtube.com/embed/eSjuBM268Yo" frameborder="0" allowfullscreen></iframe>
		</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6">
			<div class="block" data-move-x="-800px" style="width: 100%;margin-top: 4.5%">
				<img style="width: 100%;height: 340px" src="<?php echo Yii::app()->request->baseUrl;?>/images/home/img_2.jpg" alt="a cute kitten">
			</div>
		</div>
	<div class="col-md-6">
		<div class="block" data-move-x="800px" style="background: #ffffff "><br/>
			<p style="font-size: 14px;text-align: justify;">
				<?php echo substr($textoAbout[1]->text, 0, 940) . '<br/>' . substr($textoAbout[2]->text, 0, 940);?>
			</p>
			<p style="font-size: 28x; " align='right'><a href="<?php echo Yii::app()->request->baseUrl . '/' . Yii::app()->language . '/about/index'; ?>">VER MAS</a></p>
	</div>
	</div>
	</div>
	<h2 style="color: #003399;" class="block"><strong><?php echo $menus[1]['name'] ;?></strong></h2>
	<br/>
	<div class="row">
	...
	<div class="row">
	<h2 style="color: #003399;" class="block"><strong><?php echo $menus[14]['name'] ;?></strong></h2>
	<br/>
	...
	<h2 style="color: #003399;" class="block"><strong><?php echo $menus[25]['name'] ;?></strong></h2><br/>
	<div class="row">
