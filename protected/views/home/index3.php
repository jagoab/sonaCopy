		...
		<div class="row" style="">
            ...
            -->
					...
					<div class="" id="img_videoxxx" style="">
						<a target="_blank"
							href="http://www.dascomamericas-info.com/LED/promo/index.html"> <?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/banner-ep.jpg'); ?></a>
...
<div class="row">
    ...
    <?php foreach ($featured_product as $imagenesCasosDescarga): ?>
                <a
			href="<?php echo Yii::app()->baseUrl . "/products/index?idclick=" . $imagenesCasosDescarga['id'] ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . $imagenesCasosDescarga['path'], "", array('width' => '80%', 'class' => 'img-thumbnail')); ?></a>
    <?php endforeach; ?>
        </div>
