	...
	<div class="container">
		...
		<div
			...
			<div class="container">
				...
				<?php if($key == 1):?>
				<div class="block" data-move-y="200px" data-move-x="200px"
					style="clear: both; width: 842px; height: 150px; margin-left: 13%; margin-top: 5%; float: left">
					...
					<div
						style="width: 64%; height: 97px; float: left; margin-left: 20px; margin-top: -14px">
						<h1
							style="font-size: 15px; text-align: justify; line-height: 23px; font-family: Helvetica-Condensed-Light">
							<?php echo ($valor->text);?>
						</h1>
				...
				<?php if($key == 2):?>
				<div class="block" data-move-y="200px" data-move-x="-200px"
					style="clear: both; width: 842px; height: 127px; margin-left: 13%; margin-top: 30px; float: left">
					<div
						style="width: 542px; height: 97px; float: left; margin-left: 0px; margin-top: -20px">
						<h1
							style="font-size: 15px; text-align: justify; line-height: 23px; font-family: Helvetica-Condensed-Light">
							<?php echo ($valor->text);?>
						</h1>
