...
.errorMessage {
	...
	<center>
		<img src="http://dascomla.com/sonaray-ensamble/images/img/carrer.png"
			width="1081" height="82" /><br /> <br /> <br /> <br />
		<div class="row" style="width: 1200px;">
			...
			<div class="col-md-4 helvetica_neueregular">           
          <?php
										
										foreach ($contactos_list as $contacto2)
										:
											
											if (Yii::app()->session['flag'] == $contacto2['language'] || ((Yii::app()->session['flag'] == 'co' || Yii::app()->session['flag'] == 've' || Yii::app()->session['flag'] == 'pe' || Yii::app()->session['flag'] == 'pa' || Yii::app()->session['flag'] == 'cl') && $contacto2['language'] == 'us'))
											{
												?>
			...
			<div class="col-md-3 helvetica_neueregular">           
          <?php
			...
			<div style='text-align: left;'
				class="col-md-4 helvetica_condensed_lightRg">
        <?php  $form = $this->beginWidget('CActiveForm', array('id' => 'contact-form','enableClientValidation' => true,'clientOptions' => array('validateOnSubmit' => true))); ?> 
            <div style="text-align: left; color: #808080;">
                ...
                <?php echo $form->textField($model, 'city', array("class" => 'form-control', 'placeholder' =>  Yii::t('forms', 'Carrer'))); ?>
                <?php echo $form->error($model, 'city'); ?>
            </div>
				<div>
                <?php echo $form->labelEx($model, Yii::t('forms', 'Curriculum')); ?>
                <?php //echo $form->file; ?>
                 <input type="file" name="uploaded_file"
						id="uploaded-file" class='form-control'>
                <?php echo $form->error($model, 'city'); ?>
            </div>
				<div>
	...
	<noscript>
		<div style="display: inline;">
			<img height="1" width="1" style="border-style: none;" alt=""
				src="//www.googleadservices.com/pagead/conversion/1001610015/?label=GWVCCJjru1kQn7bN3QM&amp;guid=ON&amp;script=0" />
		</div>
	</noscript>
	<script type="text/javascript">
