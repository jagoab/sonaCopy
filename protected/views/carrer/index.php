...
<style>
    ...
    <center>     
              <img src="http://dascomla.com/sonaray-ensamble/images/img/carrer.png" width="1081" height="82" /><br/><br/>
      <br/><br/>    
     ...
     <div style='text-align: left;' class="col-md-4 helvetica_condensed_lightRg">
        ...
        <hr />
         ...
         <div>
                ...
                <?php //echo $form->file; ?>
                 <input type="file" name="uploaded_file" id="uploaded-file" class='form-control'>
                <?php echo $form->error($model, 'city'); ?>
            </div>
            <div>
