...
<!--				<img class="img-responsive" src="<?php //echo (Yii::app()->request->baseUrl.$imagenesAboutUs[$key]->path);?>"
			...
			<div class="container">
				...
				<div>
					...
					<h1
						style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #666666;"
						align='center'>
						<strong><?php  echo ($news->date_publication);?></strong>
					</h1>
					<center>
						<p align="justify"
							style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #666666; width: 70%">
