...
<body>
	<div class="menu" style="background: #CCCCCC;">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse"
								class="block" data-move-x="-500px" data-rotate="90deg">
								<ul class="nav navbar-nav">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li style="font-size: 15px;" class=""><a
												href="<?php echo $menu2['url']; ?>"><?php echo $menu2['name'];?></a></li></li>
	...
	<div class="container">
		<img
			src="http://dascomla.com/sonaray-ensamble/images/News/en/news.png"
			width="1081" height="82" /><br /> <br /> <img
			src="http://dascomla.com/sonaray-ensamble/images/head.png"
			width="1081" height="254" /><br /> <br /> <br />
    <?php $i = 0; ?>
   <?php
		...
		<span
			style="text-align: justify; margin-left: 14px; margin-top: 5%; font-size: 13pt; color: #999"> 
<?php echo ($valor->date_publication); ?>
		...
		<div style="">
			...
			<div
				style='width: 90%; border: 0px solid green; text-align: justify; font-family: Arial; font-size: 14px;'>

				<h1 style="font-family: Helvetica-Condensed-Light" align="right">
					<a
						href="<?php echo Yii::app()->request->baseUrl; ?>/news/cases?id=<?php echo $valor->id;?>"
						class="linkc">+</a>
				</h1>
