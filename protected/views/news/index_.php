...
<div class="container">
			...
			<?php
				...
				<?php if($key == 0):?>
				<?php //echo (Yii::app()->request->baseUrl.$imagenesAboutUs[$key]->path); ?>
				...
				<div class="container">
                                 <div style="clear:both;width: 75%; height: 80px; margin-left: 13%; margin-top: 20px; float: left">
                                     
                                         <h1 style="font-size: 12px; text-align: justify; line-height: 23px;font-family: Helvetica-Condensed-Light">
						<strong><?php  echo ($valor->date_publication);?></strong>
					</h1>
					<h1 style="font-size: 15px; text-align: justify; line-height: 23px;font-family: Helvetica-Condensed-Light">
						<?php echo ($valor->title);?>- <a href="<?php echo Yii::app()->request->baseUrl; ?>/news/cases?id=<?php echo $valor->id;?>"  class="linkc">LEER MÁS</a>
					</h1>
