...
class Languages extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'files' => array(self::HAS_MANY, 'Files', 'language'),
			'filesTypes' => array(self::HAS_MANY, 'FilesTypes', 'language'),
			'productsTexts' => array(self::HAS_MANY, 'ProductsTexts', 'language'),
			'productsTypesTexts' => array(self::HAS_MANY, 'ProductsTypesTexts', 'language'),
		);
	}
