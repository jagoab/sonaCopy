...
class ProductFiles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array (array ('file, product, file_type','required' ),array ('file, product, file_type','length','max' => 10 ),
	...
	{
		return array ('file' => 'File','product' => 'Product','file_type' => 'File Type' );
	}
