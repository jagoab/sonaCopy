...
class Casestudies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array (array ('path, subPath, order','required' ),array ('order, active','numerical','integerOnly' => true ),array ('path, subPath','length','max' => 50 ),array ('created, modified','safe' ),
	...
	{
		return array ('id' => 'ID','path' => 'Path','subPath' => 'Sub Path','order' => 'Order','active' => 'Active','created' => 'Created','modified' => 'Modified' );
	}
